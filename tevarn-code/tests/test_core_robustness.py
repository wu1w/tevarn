...
from tevarn_code.agent.file_history import FileHistory
from tevarn_code.agent.hunks import apply_selected_hunks, parse_unified_hunks
from tevarn_code.agent.loop import AgentRuntime
from tevarn_code.agent.multimodal import build_user_content
from tevarn_code.agent.permissions import PermissionGate, rules_for_profile
from tevarn_code.agent.redo import RedoEntry, RedoStack
from tevarn_code.agent.tools import ToolRuntime
from tevarn_code.bridge import BridgeConfig, build_bridge
from tevarn_code.config import AgentSettings, LLMSettings
...
from tevarn_code.llm.provider import LLMProvider, LLMResponse
from tevarn_code.plan.gate import PlanGate
...
async def test_file_history_hunk_redo(tmp_path: Path):
    ...
    assert pts
    # unified diff helper
    from tevarn_code.agent.file_history import make_unified_diff
...
async def test_null_bridge_contract():
    from tevarn_code.bridge.protocol import ToolInvokeRequest
...
def test_autoloop_controller_not_stub():
    from tevarn_code.agent import autoloop as al
