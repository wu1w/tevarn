...
from tevarn_code.config import LLMSettings, AgentSettings, load_settings
...
from tevarn_code.context.policy import recommended_thrashing
from tevarn_code.llm.provider import LLMResponse, _sanitize_messages, _truncate_tool_arguments
...
def test_p0_llm_chat_source_calls_ensure_strict():
    ...
    import tevarn_code.agent.loop as loop_mod
...
def test_p0_provider_chat_paths_use_sanitize():
    import tevarn_code.llm.provider as prov
...
async def test_p1_provider_chat_sanitizes_async():
    from tevarn_code.llm.provider import OpenAICompatibleProvider
...
class ScriptedLLM:
    ...
    async def chat_stream(self, messages, tools=None, **kwargs):
        from tevarn_code.llm.provider import StreamDelta
