"""LOCAL llama.cpp end-to-end smoke for Tevarn Code.
...
LOCAL_MODEL = os.environ.get(
    "TEVARN_CODE_MODEL", "<your-model.gguf>"
)
...
async def test_settings_session_persist(home: Path, repo: Path, session_id: str) -> None:
    ...
    # write settings
    from tevarn_code.config import save_user_settings_patch
...
async def test_bridge_interfaces_reserved() -> None:
    ...
    from tevarn_code.bridge.protocol import BRIDGE_ROUTES, ChatRequest, RAGQuery, ToolInvokeRequest
