...
def _sanitize_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    from tevarn_code.context.compressor import ensure_anthropic_strict
...
class BridgeLLMProvider(LLMProvider):
    """LLM via Tevarn Desktop bridge — stream when backend supports SSE."""
    ...
    async def chat(
        ...
        *,
        ...
        from tevarn_code.bridge.protocol import ChatMessage, ChatRequest
