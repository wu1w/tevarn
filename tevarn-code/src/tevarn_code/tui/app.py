...
from tevarn_code.agent.refs import filter_slash_commands
from tevarn_code.session.hub import SessionHub
from tevarn_code.tui.renderer import format_event_lines
from tevarn_code.tui.stream_buffer import StreamBuffer
...
class CommandPaletteScreen(ModalScreen[str | None]):
    ...
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        from tevarn_code.tui.vim_ux import PALETTE_ACTIONS
    ...
    def _rebuild(self) -> None:
        from tevarn_code.tui.vim_ux import filter_palette
...
class TevarnCodeApp(App[int]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from tevarn_code.tui.vim_ux import VimState
    ...
    def on_mount(self) -> None:
        ...
        chat.write(
            Text.from_markup(
                f"[bold #a371f7]Tevarn Code[/]  ·  mouse + keyboard + vim\n"
    ...
    def _run_search(self, query: str) -> None:
        from tevarn_code.tui.vim_ux import find_hits, highlight_line
    ...
    def _show_search_hit(self, hit: Any, *, is_current: bool = True) -> None:
        from tevarn_code.tui.vim_ux import highlight_line
    ...
    async def _open_slash(self) -> None:
        from tevarn_code.agent.refs import SLASH_COMMANDS
...
async def run_tui(
    ...
    *,
    ...
    app = TevarnCodeApp(runtime, hub=hub, open_session_cb=open_session_cb)
