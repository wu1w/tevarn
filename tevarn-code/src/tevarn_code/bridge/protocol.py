"""Desktop bridge protocol — reserved integration surface for Tevarn Desktop.

Tevarn Code runs independently. When bridge.enabled=true, the agent may
delegate models / skills / tools / MCP / RAG to a running Tevarn Desktop backend
