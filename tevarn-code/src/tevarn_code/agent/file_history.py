...
class BackupDisk:
    """~/.tevarn-code/file-history/<session_id>/<content_sha>@vN  (Claude layout)."""
...
class FileHistory:
    ...
    def __init__(self, store: Any, project_root: Path, *, home: Path | None = None) -> None:
        ...
        self.enabled = True
        from tevarn_code.agent.redo import RedoStack
    ...
    async def rewind(
        ...
        *,
        ...
        if scope in ("code", "both"):
            ...
            from tevarn_code.agent.redo import new_entry
    ...
    async def unrewind(self, session_id: str) -> dict[str, Any]:
        ...
        from tevarn_code.agent.redo import apply_redo_files
