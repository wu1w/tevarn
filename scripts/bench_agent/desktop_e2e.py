...
Optional agent loop with LLM:
  ...
  .venv311/bin/python scripts/bench_agent/desktop_e2e.py --with-agent --model local-llm
"""
...
def main() -> None:
    ...
    ap.add_argument("--model", default="local-llm", help="local-llm or kimi when --with-agent")
    args = ap.parse_args()
