...
[![Version](https://img.shields.io/badge/version-0.2.3-7C3AED?style=flat-square)](https://github.com/wu1w/takton/releases)
...
| Platform | Package | 下载 |
|----------|---------|------|
| Windows | Setup.exe | [Takton-Setup-0.2.3.exe](https://github.com/wu1w/takton/releases/download/v0.2.3/Takton-Setup-0.2.3.exe) |
| Linux | AppImage | [Takton-0.2.3.AppImage](https://github.com/wu1w/takton/releases/download/v0.2.3/Takton-0.2.3.AppImage) |
| Linux | deb | [takton_0.2.3_amd64.deb](https://github.com/wu1w/takton/releases/download/v0.2.3/takton_0.2.3_amd64.deb) |
