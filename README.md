...
[![Version](https://img.shields.io/badge/version-0.2.8-7C3AED?style=flat-square)](https://github.com/wu1w/takton/releases)
...
| Platform | Package | 下载 |
|----------|---------|------|
| Windows | Setup.exe | [Takton-Setup-0.2.8.exe](https://github.com/wu1w/takton/releases/download/v0.2.8/Takton-Setup-0.2.8.exe) |
| Windows | Portable.zip | [Takton-0.2.8-win-x64-portable.zip](https://github.com/wu1w/takton/releases/download/v0.2.8/Takton-0.2.8-win-x64-portable.zip) |
| Linux | AppImage | [Takton-0.2.8.AppImage](https://github.com/wu1w/takton/releases/download/v0.2.8/Takton-0.2.8.AppImage) |
| Linux | deb | [takton_0.2.8_amd64.deb](https://github.com/wu1w/takton/releases/download/v0.2.8/takton_0.2.8_amd64.deb) |
