...
[![Version](https://img.shields.io/badge/version-0.3.5-7C3AED?style=flat-square)](https://github.com/wu1w/takton/releases)
...
| Platform | Package | 下载 |
|----------|---------|------|
| Windows | Setup.exe | [Takton-Setup-0.3.5.exe](https://github.com/wu1w/takton/releases/download/v0.3.5/Takton-Setup-0.3.5.exe) |
| Windows | Portable.zip | [Takton-0.3.5-win-x64-portable.zip](https://github.com/wu1w/takton/releases/download/v0.3.5/Takton-0.3.5-win-x64-portable.zip) |
| Linux | AppImage | [Takton-0.3.3.AppImage](https://github.com/wu1w/takton/releases/download/v0.3.3/Takton-0.3.3.AppImage)（0.3.5 暂未出 Linux 包） |
| Linux | deb | [takton_0.3.3_amd64.deb](https://github.com/wu1w/takton/releases/download/v0.3.3/takton_0.3.3_amd64.deb)（0.3.5 暂未出 Linux 包） |
