...
```bash
curl -fsSL https://raw.githubusercontent.com/wu1w/takton/dda6eaf/scripts/install.sh | tr -d '\015' | bash
```
...
# 只安装不启动
TAKTON_NO_START=1 curl -fsSL https://raw.githubusercontent.com/wu1w/takton/main/scripts/install.sh | tr -d '\015' | bash
```
