...
[![Version](https://img.shields.io/badge/version-0.1.2-7C3AED?style=flat-square)](https://github.com/wu1w/takton/releases)
...
| Platform | Package | 下载 |
|----------|---------|------|
| Windows | Setup.exe | [Takton-Setup-0.1.2.exe](https://github.com/wu1w/takton/releases/download/v0.1.2/Takton-Setup-0.1.2.exe) |
| Linux | AppImage | [Takton-0.1.2.AppImage](https://github.com/wu1w/takton/releases/download/v0.1.2/Takton-0.1.2.AppImage) |
| Linux | deb | [takton_0.1.2_amd64.deb](https://github.com/wu1w/takton/releases/download/v0.1.2/takton_0.1.2_amd64.deb) |
