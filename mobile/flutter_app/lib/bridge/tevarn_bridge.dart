...
abstract class TevarnBridge {
  ...
  Future<Map<String, dynamic>> messages(String id, {int? limit, String? before}) =>
      call('messages', {
        'id': id,
  ...
  /// Tool-loop-aware turn probe (ready only after final assistant, no open tools).
  Future<Map<String, dynamic>> turnStatus(String id, {String? user}) =>
      call('turn_status', {
        'id': id,
