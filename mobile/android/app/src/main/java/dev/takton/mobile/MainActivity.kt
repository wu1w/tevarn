 ...
 * Debug: intent extra TAKTON_MOBILE_URL or assets fallback.
 */
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = intent?.getStringExtra("TAKTON_MOBILE_URL")
...
object Native {
    init {
        try {
            System.loadLibrary("takton_mobile_android")
