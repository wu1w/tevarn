...
# 注意：Settings 的 env_prefix="TEVARN_"——裸 DB_URL 从不生效（历史潜伏 bug，
...
os.environ.setdefault("TEVARN_AGENT_KERNEL_PERSISTENCE", "false")
...
TEST_DB_URL = os.environ["TEVARN_DB_URL"]
