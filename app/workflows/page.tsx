    ...
    <div className="flex h-full flex-col bg-elevated-bg">
      ...
      <div className="flex flex-1 overflow-hidden">
        {selected ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center text-foreground-muted">
            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-card-bg-hover">
              <svg className="h-8 w-8 text-foreground-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
                <rect x="3" y="3" width="18" height="18" rx="2" />
                <path d="M3 9h18M9 21V9" />
              </svg>
            </div>
            <p className="text-sm font-medium text-foreground-dim">选择一个工作流开始编辑</p>
            <p className="mt-1 text-xs text-foreground-muted">或点击左上角新建工作流</p>
          </div>
        )}
      </div>
